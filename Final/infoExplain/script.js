...
// document.getElementById('content').innerHTML = myPos_lo;
// document.getElementById('content').innerHTML = myPos_a;
...
function loop(){
	time = Date();
	document.getElementById('myday').innerHTML = time;
	...
	// sea.moveWaves();
	sea.mesh.rotation.y+=0.001;
	geo.mesh.rotation.y += .001;
	grass.mesh.rotation.z +=0.001;
	myClone();	
	// changeShape();// 
	controls.update();  
	document.getElementById('pos_l').innerHTML = myPos_l||0;
	document.getElementById('pos_lo').innerHTML = myPos_lo||0;
	document.getElementById('pos_a').innerHTML = myPos_a||0;
	document.getElementById('air').innerHTML = myR||0;
	renderer.render(scene, camera);
