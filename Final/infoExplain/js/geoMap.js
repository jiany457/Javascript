...
function myClone(){
			...
			clone.mesh.position.x = position.coords.latitude*position.coords.latitude-2000;
			...
			myPos_l = position.coords.latitude|| 0;
			myPos_lo = position.coords.longitude || 0;
			myPos_a = position.coords.altitude || 0;
			console.log(myPos_l);
